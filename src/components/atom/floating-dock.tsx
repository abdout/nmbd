...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden md:flex h-12 gap-2 items-end rounded-xl bg-gray-50 dark:bg-neutral-900 px-2 pb-2",
        className
      )}
    >
      {items.map((item) => (
...
function IconContainer({
  ...
  let widthTransform = useTransform(distance, [-100, 0, 100], [30, 60, 30]);
  let heightTransform = useTransform(distance, [-100, 0, 100], [30, 60, 30]);
  let widthTransformIcon = useTransform(distance, [-100, 0, 100], [15, 30, 15]);
  let heightTransformIcon = useTransform(distance, [-100, 0, 100], [15, 30, 15]);
