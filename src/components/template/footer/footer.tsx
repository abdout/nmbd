...
const DesktopFooter = () => {
  return (
    <div className="hidden md:block">
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-x-20 gap-y-10 md:gap-44 pr-16">
  ...
  return (
    <footer className="bg-gray-100 dark:bg-black antialiased font-sans text-gray-700 dark:text-neutral-300 py-6 md:py-10 relative left-[50%] right-[50%] ml-[-50vw] mr-[-50vw] w-screen flex items-center justify-center mt-4">
      <div className="w-full max-w-7xl px-4">
        ...
        <div className="flex gap-8 pr-3 md:pr-16 items-center justify-start text-gray-500 dark:text-neutral-400">
          <p>السودان</p>
          <p>العربية</p>
        </div>
      </div>
