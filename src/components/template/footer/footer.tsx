...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-6 md:py-10 relative left-[50%] right-[50%] ml-[-50vw] mr-[-50vw] w-screen flex items-center justify-center mt-4">
      <div>
        ...
        <hr className="my-4 md:my-6 border-gray-800" />
        <div className="flex gap-8 items-center justify-start text-gray-400">
          <p>السودان</p>
          <p>العربية</p>
