...
const steps = [
  { title: 'الاحكام', route: 'terms', link: onboardingRoutes.TERMS },
  { title: 'المرفقات', route: 'attachment', link: onboardingRoutes.ATTACHMENT },
  { title: 'الاتصال', route: 'contact', link: onboardingRoutes.CONTACT },
  { title: 'المعلومات', route: 'basic-info', link: onboardingRoutes.BASIC_INFO },
  { title: 'العنوان', route: 'address', link: onboardingRoutes.ADDRESS },
