...
const steps = [
  ...
  { title: 'المرفقات', route: 'attachment', link: '/onboarding/attachment', icon: 'attachment' },
  { title: 'الاتصال', route: 'contact', link: '/onboarding/contact', icon: 'contact' },
  { title: 'المعلومات', route: 'information', link: '/onboarding/information', icon: 'information' },
  { title: 'التعليم', route: 'education', link: '/onboarding/education', icon: 'education' },
