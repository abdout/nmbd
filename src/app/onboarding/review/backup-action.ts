...
/**
 * Update applicationStatus for a user (for approve, reject, undo)
 */
export async function updateUserApplicationStatus(userId: string, status: string): Promise<{ success: boolean; error?: string }> {
  try {
